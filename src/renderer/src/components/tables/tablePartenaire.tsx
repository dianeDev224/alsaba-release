...
export  const TablePartenaire = React.memo(({data = []})=>{
      ...
      return(
        <div className='flex flex-row justify-center items-center space-x-3'>
          <FaEye className='cursor-pointer' color={'#7b3535'} onClick={()=>{
            navigator('/partenaires/details-partenaires' , { state : {paysData : rowData} })
            }}/>
    ...
    function tableHeader(){
      return(
          ...
          <div className="p-inputgroup">
              <InputText placeholder={"Chercher un partenaire"}
              value={filters.value}
              onChange={(e)=>{
...
// tableau pour les frais des partenaires
export  const TableFraisPartenaire = React.memo(({data = []})=>{
    ...
    const  deleteRow = useCallback(
      ...
      function FraisBodyTemplate(rowData){
    ...
    function tableHeader(){
      return(
          ...
          <div className="p-inputgroup">
              <InputText placeholder={"Chercher un frais"}
              value={filters.value}
              onChange={(e)=>{
                const value = e.target.value;
                let _filters = { ...filters };
    ...
    return (
      <div className='flex flex-col flex-1 space-y-3 '>
        ...
        <DataTable
          ...
          filters={filters}
          stateStorage="session" stateKey="dt-state-demo-local"
          emptyMessage={<div className="flex flex-row w-full justify-center items-center"><p className="font-light text-[#827c7c]">ce partenaire n'a pas de frais</p></div>}
          pt={{
            table : {className : 'w-full border-[2px] border-[#e1dfd8] text-[#383838]'} , 
            thead : {className : 'w-full bg-[#aeaca4] text-[#eff3f8] rounded-sm border-[2px] border-[#e1dfd8] '} , 
            paginator : {
        ...
        >
            ...
            />
            <Column field="borneInf" header="borne inferieure"
              pt={{
                headerCell : {className : 'border-[2px] border-[#e1dfd8]'} , 
                bodyCell : {className : 'border-[2px] border-[#e1dfd8] text-center'}
              }}
            />
            <Column field="borneSup" header="borne superieure"
              pt={{
                headerCell : {className : 'border-[2px] border-[#e1dfd8]'} , 
                bodyCell : {className : 'border-[2px] border-[#e1dfd8] text-center'}
              }}
